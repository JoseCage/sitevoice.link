...
<div>
    @section('dashcontent')
        <div class="md:max-w-6xl md:mx-auto px-4 py-8">
					...
					<div class="bg-orange-200 text-red-700 px-6 py-4 rounded-lg relative mb-5" role="alert" x-data="{ open: true }" x-show.transition="open">
						<div class="mr-4">
							<strong class="font-bold">Voice Credits!</strong>
							<span class="block sm:inline">You have <b>100</b> voice credits. <a href="/billing"><b>Upgrade</b></a> your account if you need more.</span>
						</div>
					...
					<div class="flex items-center justify-between mb-4">
						...
						{{--<a href="{{ route('dashboard.sites.create') }}" class="shadow inline-flex items-center bg-blue-500 hover:bg-blue-600 focus:outline-none focus:shadow-outline text-white font-semibold py-2 px-4 rounded-lg">
					...
					<div class="flex items-center justify-between mb-4">
						<h2 class="text-xl font-bold text-gray-800">Last Articles</h2>

						<a href="{{ route('dashboard.articles') }}" class="text-blue-600 hover:text-blue-500 font-medium">View all</a>
					</div>
						...
						<table class="w-full whitespace-no-wrap bg-white overflow-hidden table-striped">
							<thead>
								<tr class="text-left">
									...
									<th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs">Title</th>
                                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs text-right">Site</th>
								...
								<tr class="focus-within:bg-gray-200 overflow-hidden">
                                    ...
                                    <td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center justify-end">
                                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="play w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="pause w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="share w-6 h-6">

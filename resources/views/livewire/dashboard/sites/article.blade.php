...
<div>
    @section('dashcontent')
        <div class="md:max-w-6xl md:mx-auto px-4 py-8">
					...
					<div class="flex items-center justify-between mb-4">
						{{--<h2 class="text-xl font-bold text-gray-800">All Articles</h2>--}}
...
{{--									<th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs">Status</th>--}}
							...
							<tbody>
								@foreach($articles as $article)
									...
									<td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center">{{ $article->title }}</span>
									</td>
									<td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center justify-end">{{ $article->site->name }}</span>
									</td>
									<td class="border-t">
										<span class="px-6 py-4 flex items-center">
											<span class="text-gray-700 px-6 py-4 flex items-center justify-end">{{ $article->created_at->diffForHumans() }}</span>
										</span>
									</td>
                                    <td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center justify-end">
                                            <a href="{{ route('dashboard.articles.download', $article) }}">
                                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="download w-6 h-6">

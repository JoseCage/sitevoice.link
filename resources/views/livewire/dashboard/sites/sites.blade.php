    ...
    @section('dashcontent')
        ...
        <div class="md:max-w-6xl md:mx-auto px-4 py-8">
					...
					<div class="bg-orange-200 mb-10 p-6 rounded-lg shadow">
						<div class="md:flex">
							<div class="md:w-1/2">
								<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-2 leading-tight">Your Site needs a voice</h2>

								<p class="text-gray-700 mb-4">Let anyone listen for the content on your site as if they are listening music.</p>
					...
					<div class="flex items-center justify-between mb-4">
						<h2 class="text-xl font-bold text-gray-800">My sites</h2>
						...
						<table class="w-full whitespace-no-wrap bg-white overflow-hidden table-striped">
							<thead>
								<tr class="text-left">
                                    ...
                                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs text-right">URL</th>
									<th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs">Articles</th>
							...
							<tbody>
								@foreach($sites as $site)
									...
									<td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center">{{ $site->name }}</span>
									</td>
									<td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center">{{ $site->url }}</span>
									</td>
									<td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center justify-end">{{ $site->articles->count() }}</span>
									</td>
									<td class="border-t">
										<span class="px-6 py-4 flex items-center">
											@if($site->status === 1)
                                                <span class="px-2 rounded-full text-sm uppercase tracking-wide font-semibold bg-green-200 text-green-800">Active</span>
                                            @else
                                                <span class="px-2 rounded-full text-sm uppercase tracking-wide font-semibold bg-orange-200 text-orange-800">Inactive</span>
                                            @endif
										</span>
									</td>
                                    <td class="border-t">
										<span class="text-gray-700 px-6 py-4 flex items-center justify-end">
                                            <a href="{{ route('dashboard.sites.edit', $site) }}" title="Edit website">
                                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="pencil-alt w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                            </svg>
                                            </a>
                                            <a href="{{ route('dashboard.sites.delete', $site->uuid) }}" title="Delete website">
                                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="trash w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                            </svg>
                                            </a>
                                            <a href="{{ $site->url }}" target="_blank" rel="nofollow" title="Open Site">
                                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="external-link w-6 h-6">
